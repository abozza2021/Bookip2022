...
public class principal {
  ...
  @Autowired
  private Registros BuscarNombreCliente ;
    ...
    @Autowired
    private Registros BuscarNumeroCliente ;
        ...
        @Autowired
           ...
           private  Usuarios login;
             ...
             public @ResponseBody List<usuarios> login(@RequestParam String username , String password) 
             {
               ...
               @Autowired
  private Registros borrarreg ;
  @PostMapping(path="/borrarreg")
  public @ResponseBody List<registros> borrarregistro(@RequestParam String id) 
  {

    // return (null);
    return borrarreg.borrarregistro(id) ;
  } 
